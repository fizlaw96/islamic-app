            ...
            <div className="flex flex-col items-center justify-center m-6">
                <div className="w-full sm:max-w-md bg-white dark:bg-green-800 shadow-lg rounded-lg p-6">
                    ...
                    <form onSubmit={submit} className="mt-4">
                        <div>
                            <InputLabel htmlFor="name" value={language === "bm" ? "Nama" : "Name"} className="text-green-700 dark:text-black" />
                        ...
                        <div className="mt-4">
                            <InputLabel htmlFor="password_confirmation" value={language === "bm" ? "Sahkan Kata Laluan" : "Confirm Password"} className="text-green-700 dark:text-black" />
